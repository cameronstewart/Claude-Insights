...
Microsoft consultancy helping to get people to get more out of their micosoft aibscriptions
Use microsoft tools and xero for finance

## Project Information

- **UUID:** `0197170f-cd62-7295-9d0c-4b7e5a399688`
- **Creator:** Cameron Stewart
- **Created:** 2025-05-28T13:23:21.060389+00:00
- **Updated:** 2025-05-29T02:46:45.132939+00:00
- **Category:** ai-development
- **Documents:** 9

## Documents

This project contains 9 document(s). Each document is stored as a separate markdown file with metadata in the frontmatter.
